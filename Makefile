...
## test - Test the project
sample:
	$(VIRTUAL_BIN)/python ./sample/sample.py

.PHONY: help build coverage clean black black-check format format-check install isort isort-check lint mypy test sample
